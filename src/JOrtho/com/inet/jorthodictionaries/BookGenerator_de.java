...
public class BookGenerator_de extends BookGenerator {
    ...
    boolean isValidLanguage(String word, String wikiText) {   
        ...
        if( idxGerman < 0 || word.endsWith( "(Deklination)" ) || word.endsWith( "(Konjugation)" )){
            ...
            props = BookUtils.parseRule( wikiText, "Deutsch Verb unregelmig", 0 );
            if(props != null){
...
//            }
    ...
    private final void searchFlexion( String word, String wikiText ){
        ...
        while(idx > 0){
            ...
            Properties props = BookUtils.parseRule( wikiText, "Deutsch Adjektiv bersicht", idx);
            if(props != null){
     ...
     * http://de.wiktionary.org/wiki/Vorlage:Deutsch_Substantiv_bersicht
     */
